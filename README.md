...
| [分贝仪](https://tool.yule.ink/decibel)              | 实时麦克风音量检测             | 使用麦克风实时监测环境音量，以分贝（dB）为单位显示当前声音强度，并提供峰值记录和平均值统计。附有声音等级参考表，适用于录音场景评估、噪音检测和环境监控。                    |
...
| 标题                                                   | 副标题                     | 简介                                                                                                                                                                                 |
| ------------------------------------------------------ | -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [健身锻炼](https://tool.yule.ink/exercises)            | 1324 个健身动作图解        | 收录 1324 个专业健身动作，涵盖背部、胸部、肩部、腿部、腰部等全身肌群。每个动作配有图解和详细步骤说明，支持按部位和器材筛选，适合健身爱好者参考和制定训练计划。                       |
| [MBTI 人格测试](https://tool.yule.ink/mbti)            | 探索你的 16 型人格         | 通过 100 道科学题目，分析你在外向/内向、实感/直觉、思维/情感、判断/知觉四个维度的偏好，得出专属你的 MBTI 16 型人格结果。题目每次随机排列，结果客观中立。                             |
...
| [气象预警](https://tool.yule.ink/alarm)                | 中央气象台全国气象预警查询 | 查询中央气象台发布的全国气象预警信息。支持按省份、预警类型（台风、暴雨、寒潮等）和预警级别（蓝/黄/橙/红）筛选，提供预警列表和详细文本内容，帮助及时了解各地灾害性天气预警。          |
...
| [QQ 头像获取](https://tool.yule.ink/qq-avatar)         | 通过 QQ 号获取头像链接     | 输入 QQ 号码，一键获取 4 种清晰度（40px、100px、640px 标准、640px 高清）的头像图片及对应 URL。受浏览器跨域限制，头像图片无法直接下载，可复制 URL 在浏览器中打开后另存。              |
...
| [中国 GDP](https://tool.yule.ink/china-gdp)              | 1952 - 2025 国内生产总值数据 | 直观展示中国 1952 年至 2025 年的国内生产总值（GDP）、国民总收入（GNI）及人均国内生产总值变化趋势，配合多维度统计图表展示。                 |
