...
| 标题                                                | 副标题                    | 简介                                                                                                                                                                                                              |
| --------------------------------------------------- | ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [2026 世界杯](https://tool.yule.ink/world-cup_2026) | 2026 美加墨世界杯赛程     | 展示 2026 年美加墨世界杯完整赛程和比赛结果。包含小组赛（A-P 共 16 组）和淘汰赛（32 强至决赛）全部比赛数据，支持国旗展示和点球大战比分。时间自动转换为北京时间。                                                   |
| [AI 杠精](https://tool.yule.ink/ai-nitpicker)       | 无论你说什么，AI 都会抬杠 | 一个永远跟你对着干的 AI 聊天机器人。无论你分享快乐、表达观点还是陈述事实，AI 都会从刁钻角度进行反驳和抬杠。语气幽默讽刺，让人又气又笑。支持多轮对话，上下文连贯。适合解压娱乐、测试逻辑漏洞、体验 AI 的另类用法。 |
...
| [世界人口数量](https://tool.yule.ink/world-population)   | 实时世界人口计数器           | 基于联合国最新预测数据的实时世界人口计数器。动态显示当前全球人口总数、今年累积出生和死亡人数，数据每 50 毫秒刷新一次，模拟世界人口的实时变化，直观呈现全球人口增长。 |

### 学习工具

| 标题                                            | 副标题                 | 简介                                                                                                                                            |
| ----------------------------------------------- | ---------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| [化学方程式配平](https://tool.yule.ink/balance) | 自动配平化学反应方程式 | 输入未配平的化学方程式，自动计算并输出配平后的方程式。支持 LaTeX 数学渲染，提供漂亮的化学方程式展示。适用于化学学习、作业检查、实验设计等场景。 |
