...
<template>
  <div class="space-y-12">
    ...
    >
      <div class="flex items-center gap-2 overflow-x-auto no-scrollbar pb-1 md:pb-0">
        <button
          ...
          :class="[navigationStore.activeCategoryId === cat.id ? 'btn-primary' : 'btn-secondary']"
    ...
    <div class="space-y-20 mt-8">
      <section v-for="cat in categories" :id="cat.id" :key="cat.id" class="scroll-mt-24 space-y-6">
