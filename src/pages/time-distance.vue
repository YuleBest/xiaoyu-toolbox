...
const startDate = ref<any>(new CalendarDate(startYest.year, startYest.month, startYest.day))
const startDateStr = ref(startYest.toString()) // YYYY-MM-DD
const startTimeStr = ref('00:00:00')
const startTimeRef = ref({ h: 0, m: 0, s: 0 })

const endDate = ref<any>(new CalendarDate(currentDate.year, currentDate.month, currentDate.day))
...
const distance = computed(() => {
  if (!startDate.value || !endDate.value) return { days: 0, hours: 0, minutes: 0, seconds: 0 }
    ...
    <div class="max-w-4xl mx-auto space-y-6 md:space-y-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
                    ...
                    <div class="flex gap-3 font-bold text-center">
                      ...
                      >
                        <div
                          ...
                          :class="
                            startTimeRef.h === h ? 'text-blue-500 text-lg' : 'text-muted-foreground'
                          "
                      ...
                      >
                        <div
                          ...
                          class="py-2 cursor-pointer snap-center hover:bg-blue-500/10 transition-colors"
                          :class="
                            startTimeRef.m === m ? 'text-blue-500 text-lg' : 'text-muted-foreground'
                          "
                      ...
                      >
                        <div
                          ...
                          class="py-2 cursor-pointer snap-center hover:bg-blue-500/10 transition-colors"
                          :class="
                            startTimeRef.s === s ? 'text-blue-500 text-lg' : 'text-muted-foreground'
                          "
                    ...
                    <div class="flex gap-3 font-bold text-center">
                      ...
                      >
                        <div
                          ...
                          :class="
                            endTimeRef.h === h ? 'text-rose-500 text-lg' : 'text-muted-foreground'
                          "
                      ...
                      >
                        <div
                          ...
                          class="py-2 cursor-pointer snap-center hover:bg-rose-500/10 transition-colors"
                          :class="
                            endTimeRef.m === m ? 'text-rose-500 text-lg' : 'text-muted-foreground'
                          "
                      ...
                      >
                        <div
                          ...
                          class="py-2 cursor-pointer snap-center hover:bg-rose-500/10 transition-colors"
                          :class="
                            endTimeRef.s === s ? 'text-rose-500 text-lg' : 'text-muted-foreground'
                          "
        ...
        >
          ...
          <h2 class="text-xs font-bold text-muted-foreground uppercase tracking-widest mb-4">
