export default {
  ...
  footer: {
    ...
    disclaimer:
      "提供されるすべてのツールは学習および研究目的のみに使用してください。",
  },
  ...
  tools: {
    base64: {
      ...
      description:
        "テキストと Base64 エンコードを相互変換します。UTF-8 や特殊文字にも対応。",
      usage:
        "左側にテキストを入力するとエンコード、右側に Base64 を入力するとデコードされます。",
    },
    "json-yaml": {
      title: "JSON-YAML 変換",
      subtitle: "設定フォーマットの相互変換",
      description:
        "JSON と YAML を素早く変換します。リアルタイムのバリデーションに対応。",
    },
    playground: {
      title: "JS プレイグラウンド",
      subtitle: "ブラウザ内 JS / TS サンドボックス",
      description:
        "ブラウザ上で JavaScript/TypeScript を実行できるサンドボックス環境です。",
    },
    qrcode: {
      title: "QRコードツール",
      subtitle: "生成と読み取り、スタイル編集",
      description:
        "カスタムQRコードの生成や、画像からの読み取りが可能です。画像の保存もサポート。",
    },
    exif: {
      title: "画像 EXIF 表示",
      subtitle: "メタデータの確認",
      description:
        "カメラ情報、撮影パラメータ、GPS 位置などの EXIF データを表示します。",
    },
    dydown: {
      title: "Douyin 動画解析",
      subtitle: "透かしなし動画保存",
      description:
        "Douyin の共有リンクから透かしなしの動画と作成者情報を取得します。",
    },
    bilidown: {
      title: "BiliBili 動画解析",
      subtitle: "ストリーム統合と保存",
      description:
        "Bilibili の動画リンクから音声を統合した動画を取得します。FFmpeg WASM を使用。",
    },
    lyric: {
      title: "歌詞取得",
      subtitle: "検索とダウンロード",
    ...
    hok: {
      ...
      subtitle: "ゲームデータの検索",
      description:
        "王者栄耀のヒーロー、装備、スキルなどのデータを検索できます。",
    },
    reaction: {
      title: "反応速度テスト",
      subtitle: "ミリ秒単位の測定",
      description:
        "視覚的な反応速度をテストします。画面が緑になったらクリックしてください。",
    },
    jichacha: {
      title: "機査査 (JiChacha)",
      subtitle: "デバイス情報の検索",
      description:
        "スマートフォンのモデル名、コードネーム、詳細スペックを検索できます。",
    },
    mcpe: {
      title: "MC PE ダウンロード",
    ...
    codeimg: {
      ...
      description:
        "Carbon のようにコードを綺麗なスクリーンショット画像に変換します。",
    },
    hhsh: {
      title: "好好説話 (Speak Nicely)",
      subtitle: "ピンイン略語辞典",
      description:
        "awsl などの中国ネット用語（ピンイン略語）の意味を検索できます。",
    },
    exchange: {
      title: "為替レート",
      subtitle: "リアルタイム変換と推移",
      description:
        "Frankfurter API を使用した主要通貨の為替レート検索ツールです。",
    },
    length: {
      title: "長さ単位換算",
      subtitle: "各単位の相互変換",
      description:
        "メートル法、ヤード・ポンド法、中国・香港の伝統的な単位を変換します。",
    },
    "phone-number": {
      title: "電話番号検索",
      subtitle: "発信元・キャリア情報",
      description:
        "中国の携帯電話番号の所在地域と通信事業者をオフラインで検索します。",
    },
    bvav: {
      title: "BV/AV 変換",
    ...
    "weibo-hot": {
      ...
      subtitle: "トレンドランキング",
      description:
        "Weibo (微博) のリアルタイムおよび過去のトレンド情報を取得します。",
    },
    period: {
      title: "生理周期管理",
  ...
  qrcode: {
    ...
    errorLevel: "誤り訂正レベル",
    errorLevelDesc:
      "L: 7%, M: 15%, Q: 25%, H: 30%。高レベルほど一部が隠れても読込可能です。",
    qrColor: "QRの色",
    margin: "余白",
    size: "サイズ",
    preview: "プレビュー",
  ...
  exif: {
    ...
    parseFailed:
      "解析に失敗しました。サポートされていない形式の可能性があります。",
  ...
  bilidown: {
    ...
    cookieTip:
      "Cookieを使用すると 1080P+ の画質が解放されます。一時的な使用のみで保存されません。",
    videoStream: "映像",
    audioStream: "音声",
    ...
    disclaimerItem5:
      "FFmpeg はブラウザ内で動作し、データがアップロードされることはありません",
    quality: "画質",
    codec: "コーデック",
  ...
  weather: {
    ...
    sunset: "日の入り",
    searchTip:
      "ヒント: 日本語で見つからない場合は、ローマ字で試してみてください。",
  },
