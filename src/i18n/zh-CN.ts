export default {
  ...
  tools: {
    ...
    'json-yaml': {
      title: 'JSON-YAML 转换',
      subtitle: '配置文件格式互转',
      description: '方便快捷的 JSON 与 YAML 格式互转工具，支持实时校验和格式化。',
      usage:
        '1. 粘贴 JSON 或 YAML 内容。\n2. 点击转换按钮即可进行格式转换。\n3. 支持一键复制和清空。',
    },
    playground: {
    ...
    qrcode: {
      ...
      description: '快速生成自定义二维码，或识别图片中的二维码内容。支持下载生成的二维码图片。',
      usage:
    ...
    exif: {
      title: '图片 EXIF 查看',
      subtitle: '查看图片元数据',
      description: '读取和显示图片的 EXIF 元数据，包括相机信息、拍摄参数、GPS 位置等。',
      usage:
    ...
    weather: {
      title: '天气查询',
      subtitle: '全国天气实时查询',
      description: '基于和风天气的全球天气查询工具，支持查看实时天气、每小时预报及未来天气趋势。',
      usage:
    ...
    hhsh: {
      title: '好好说话',
      subtitle: '拼音首字母缩写释义',
      description: '查询网络常见拼音首字母缩写的含义，例如 awsl、xswl 等。支持提交新词条。',
      usage:
    ...
    length: {
      title: '长度单位换算',
      subtitle: '常用长度单位双向换算',
      description: '支持常见的公制、英制、市制等多种长度单位的双向实时换算转换。',
      usage:
    ...
    'weibo-hot': {
      title: '微博热搜',
      subtitle: '获取历史和实时热搜',
      description: '获取指定日期的微博热搜榜单数据，支持按条数筛选和查看原链接。',
      usage:
