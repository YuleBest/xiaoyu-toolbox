export default {
  ...
  meta: {
    home: {
      ...
      keywords:
        "toolbox, online tools, developer tools, image tools, video parser",
    },
  },
  ...
  tools: {
    ...
    playground: {
      ...
      description:
        "Interactive JavaScript/TypeScript environment in your browser.",
    },
    qrcode: {
      title: "QR Code",
    ...
    bilidown: {
      ...
      description:
        "Parse Bilibili videos and merge streams in-browser via FFmpeg.",
    },
    lyric: {
      title: "Lyric Fetcher",
    ...
    "translator-ai": {
      ...
      description:
        "Privacy-focused local translation using Chrome's native API.",
    },
    codeimg: {
      title: "Code to Image",
