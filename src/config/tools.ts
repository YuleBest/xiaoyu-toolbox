...
export const toolsData: Record<string, Tool[]> = {
  dev: [
    ...
    {
      id: 'password-gen',
      title: 'tools.password-gen.title',
      subtitle: 'tools.password-gen.subtitle',
      description: 'tools.password-gen.description',
      author: 'Yule',
      usage: 'tools.password-gen.usage',
      icon: KeyRound,
  ...
  stats: [
    ...
    {
      id: 'china-gdp',
      title: 'tools.china-gdp.title',
      subtitle: 'tools.china-gdp.subtitle',
      description: 'tools.china-gdp.description',
      author: 'Yule',
      usage: 'tools.china-gdp.usage',
      icon: BadgeDollarSign,
      color: 'text-blue-500',
      path: '/china-gdp',
      date: '2026-07-15',
